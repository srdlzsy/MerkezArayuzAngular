...
import { GidenFirmaSevkleriCreateComponent } from '../create/giden-firma-sevkleri-create.component';
import { GidenFirmaSevkleriDetailComponent } from '../detail/giden-firma-sevkleri-detail.component';
...
@Component({
  selector: 'app-giden-firma-sevkleri-list',
  standalone: true,
  imports: [CommonModule, ApiListTableComponent],
  templateUrl: '../../../core/api-list-page/api-list-page.template.html',
  styleUrl: './giden-firma-sevkleri-list.component.scss'
})
export class GidenFirmaSevkleriListComponent extends ApiTaskListPageBase<IFurpaCompanyMovementListItemApiDto> {
  ...
  protected readonly detailComponent = GidenFirmaSevkleriDetailComponent;
  protected readonly createComponent = GidenFirmaSevkleriCreateComponent;
