...
@Component({
  selector: 'app-manav-operasyon-paneli-list',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './manav-operasyon-paneli-list.component.html',
  styleUrl: './manav-operasyon-paneli-list.component.scss'
})
export class ManavOperasyonPaneliListComponent {
