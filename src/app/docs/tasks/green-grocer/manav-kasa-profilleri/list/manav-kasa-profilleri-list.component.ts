...
@Component({
  selector: 'app-manav-kasa-profilleri-list',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, ApiListTableComponent],
  templateUrl: './manav-kasa-profilleri-list.component.html',
  styleUrl: './manav-kasa-profilleri-list.component.scss'
})
export class ManavKasaProfilleriListComponent {
