...
@Component({
  ...
  templateUrl: './firma-mal-kabulleri-create.component.html',
  styleUrl: './firma-mal-kabulleri-create.component.scss'
})
export class FirmaMalKabulleriCreateComponent extends DocsTaskDialogBase {
