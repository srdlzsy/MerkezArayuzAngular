...
@Component({
  selector: 'app-alinan-firma-siparisleri-detail',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './alinan-firma-siparisleri-detail.component.html',
  styleUrl: './alinan-firma-siparisleri-detail.component.scss'
})
export class AlinanFirmaSiparisleriDetailComponent extends SiparisTaskDetailBase<
