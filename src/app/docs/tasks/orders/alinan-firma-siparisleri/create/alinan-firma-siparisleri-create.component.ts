...
@Component({
  selector: 'app-alinan-firma-siparisleri-create',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './alinan-firma-siparisleri-create.component.html',
  styleUrl: './alinan-firma-siparisleri-create.component.scss'
})
export class AlinanFirmaSiparisleriCreateComponent extends DocsTaskDialogBase {
  ...
  protected submit(): void {
    ...
    this.siparisIslemleriService
      .createAlinanSiparis(this.buildRequest())
      ...
      .subscribe({
        ...
        error: (error: HttpErrorResponse) => {
          this.submitError.set(
            this.resolveErrorMessage(error, 'Alinan siparis kaydedilirken hata olustu.')
          );
        }
      });
  }
