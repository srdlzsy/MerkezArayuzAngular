...
@Component({
  selector: 'app-kullanicilar-detail',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './kullanicilar-detail.component.html',
  styleUrl: './kullanicilar-detail.component.scss'
})
export class KullanicilarDetailComponent implements OnInit {
