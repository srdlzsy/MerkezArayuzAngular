...
@Component({
  selector: 'app-kullanicilar-list',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './kullanicilar-list.component.html',
  styleUrl: './kullanicilar-list.component.scss'
})
export class KullanicilarListComponent implements OnInit {
