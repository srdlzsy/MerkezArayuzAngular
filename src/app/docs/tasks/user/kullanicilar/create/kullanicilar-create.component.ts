...
@Component({
  selector: 'app-kullanicilar-create',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './kullanicilar-create.component.html',
  styleUrl: './kullanicilar-create.component.scss'
})
export class KullanicilarCreateComponent implements OnInit {
