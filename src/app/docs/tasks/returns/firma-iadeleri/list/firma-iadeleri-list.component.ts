...
import { FirmaIadeleriCreateComponent } from '../create/firma-iadeleri-create.component';
import { FirmaIadeleriDetailComponent } from '../detail/firma-iadeleri-detail.component';
...
@Component({
  selector: 'app-firma-iadeleri-list',
  standalone: true,
  imports: [CommonModule, ApiListTableComponent],
  templateUrl: '../../../core/api-list-page/api-list-page.template.html',
  styleUrl: './firma-iadeleri-list.component.scss'
})
export class FirmaIadeleriListComponent extends ApiTaskListPageBase<IFurpaCompanyMovementListItemApiDto> {
  ...
  protected readonly detailComponent = FirmaIadeleriDetailComponent;
  protected readonly createComponent = FirmaIadeleriCreateComponent;
