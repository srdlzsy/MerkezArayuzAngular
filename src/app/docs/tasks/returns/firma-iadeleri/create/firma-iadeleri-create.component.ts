...
@Component({
  selector: 'app-firma-iadeleri-create',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './firma-iadeleri-create.component.html',
  styleUrl: './firma-iadeleri-create.component.scss'
})
export class FirmaIadeleriCreateComponent extends DocsTaskDialogBase {
  ...
  protected submit(): void {
    ...
    this.iadeIslemleriService
      .createFirmaIade(this.buildRequest())
      ...
      .subscribe({
        ...
        error: (error: HttpErrorResponse) => {
          this.submitError.set(
            this.resolveErrorMessage(error, 'Firma iade kaydedilirken hata olustu.')
          );
        }
      });
  }
