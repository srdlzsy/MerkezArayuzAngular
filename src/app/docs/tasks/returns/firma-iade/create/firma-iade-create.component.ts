...
@Component({
  selector: 'app-firma-iade-create',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './firma-iade-create.component.html',
  styleUrl: './firma-iade-create.component.scss'
})
export class FirmaIadeCreateComponent extends DocsTaskDialogBase {
