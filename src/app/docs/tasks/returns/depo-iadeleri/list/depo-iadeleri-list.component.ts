...
import { DepoIadeleriCreateComponent } from '../create/depo-iadeleri-create.component';
import { DepoIadeleriDetailComponent } from '../detail/depo-iadeleri-detail.component';
...
@Component({
  selector: 'app-depo-iadeleri-list',
  standalone: true,
  imports: [CommonModule, ApiListTableComponent],
  templateUrl: '../../../core/api-list-page/api-list-page.template.html',
  styleUrl: './depo-iadeleri-list.component.scss'
})
export class DepoIadeleriListComponent extends ApiTaskListPageBase<
  IFurpaWarehouseReturnListItemApiDto,
  DepoIadeleriDetailDialogData
> {
  ...
  protected readonly detailComponent = DepoIadeleriDetailComponent;
  protected readonly createComponent = DepoIadeleriCreateComponent;
  ...
  protected override buildDetailData(row: IFurpaWarehouseReturnListItemApiDto): DepoIadeleriDetailDialogData {
