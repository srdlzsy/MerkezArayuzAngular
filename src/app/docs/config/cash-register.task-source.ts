          ...
          endpoints: [
            {
              ...
              description: 'Terazi export isini kuyruga alir; warehouseNo yalniz all-warehouses depo secimi icindir'
            },
            {
              method: 'GET',
              path: '/api/operations/productbarcodeplunofile?warehouseNo=110',
              description: 'Urun/barcode/PLU export isini kuyruga alir; warehouseNo yalniz all-warehouses depo secimi icindir'
            },
            {
              method: 'GET',
              path: '/api/operations/cashierfile?warehouseNo=110',
              description: 'Kasiyer export isini kuyruga alir; warehouseNo yalniz all-warehouses depo secimi icindir'
            },
            {
              method: 'GET',
  ...
  'etiket-belgeleri': singleRouteTask(
    {
      ...
      highlights: [
        ...
        'kasa-islemleri.etiket-belgeleri.all-warehouses icin opsiyonel warehouseNo query destegi',
        'Belge bazli yukleme',
          ...
          endpoints: [
            {
              ...
              description: 'Belirli zamandan sonra fiyati degisen urunleri getirir; warehouseNo all-warehouses yetkisiyle opsiyoneldir'
            },
            {
              method: 'GET',
            ...
            },
            {
              ...
              description: 'Secilen gun icin kunye/tag kayitlarini getirir; warehouseNo all-warehouses yetkisiyle opsiyoneldir'
            }
          ]
        }
      ]
  ...
  'kasa-sayimlari': singleRouteTask(
    {
      ...
      highlights: [
        ...
        'Detay, banknot ve hediye ceki guncellemeleri patch degildir; UI kalacak tum satirlari son haliyle gonderir',
      ...
      items: [
        {
          ...
          endpoints: [
            ...
            {
              method: 'PUT',
              path: '/api/kasa-islemleri/kasa-sayimlari/{seri}/{sira}/hediye-ceki-hareketleri',
              description: 'Secili kasa sayimi fiziksel hediye ceki satirlarini son durumda kalacak tum hediye ceki listesiyle gunceller',
              payload: 'UpdateCashSummaryGiftChecksHttpRequest'
            },
            {
              method: 'DELETE',
  ...
  'icmal-kaydi-girisi': multiRouteTask(
    {
      ...
      highlights: [
        ...
        'total UI tarafinda hesaplanmak zorunda degildir; backend legacy belge toplamlarini kendi hesaplar, UI tercihen 0 gonderir',
        'legacy CARI/Z fark toplaminda paymentTypeNo < 100 odemeler, banknotlardan uretilen nakit toplam ve storeExpenses sayilir; paymentTypeNo = 100 Gider Pusulasi haric tutulur',
        'Create response icindeki total ekranda gosterilen tahsilat toplamindan farkli olabilir; liste, detay ve yazdirma satir tutarlarindan kendi toplamlarini hesaplamalidir',
        'UI create ekraninda Tahsilat Toplami, Magaza Gideri, Gider Pusulasi, Z Fark Bazi, Z Farki ve Genel Bilgi Toplami kavramlari ayrilmalidir',
        'Nakit toplam paymentTypes icinden gonderilmez; backend banknot hareketlerinden 500 satirini uretir',
        'Backend nakit satirinin slipNumber degerini banknot adet toplami olarak yazar',
